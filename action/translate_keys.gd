class TranslateKeys:
	...
	func merge_override_keys(keys:TranslateKeys, fallback_translation:Vector3)->void:
		...
		var last_x = _key_resource.Key.new(0.0, fallback_translation.x) 
		var last_y = _key_resource.Key.new(0.0, fallback_translation.y) 
		var last_z = _key_resource.Key.new(0.0, fallback_translation.z) 
	...
	func _compute_complete_keys(fallback_translation: Vector3)->void:
		var all_times:Dictionary={}
